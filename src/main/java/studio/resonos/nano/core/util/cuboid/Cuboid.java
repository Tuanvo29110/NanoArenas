package studio.resonos.nano.core.util.cuboid;
...
public class Cuboid implements Iterable<Location> {
    ...
    public Location getCenter() {
        return new Location(
                getWorld(), getLowerX() + (getUpperX() - getLowerX()) / 2f,
                getLowerY() + (getUpperY() - getLowerY()) / 2f, getLowerZ() + (getUpperZ() - getLowerZ()) / 2f
        );
    }
